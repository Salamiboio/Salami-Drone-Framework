//Made by Salami._.
class SAL_DroneJammerTurnOffAction : SCR_InventoryAction
{
	IEntity m_eBag;
	...
	override void PerformAction(IEntity pOwnerEntity, IEntity pUserEntity) 
	{
		...
		{
			SAL_DroneClientComponent.GetInstance().UpdatePowers(m_cLoadoutStorage.GetClothFromArea(LoadoutBackpackArea), false);
		}
		else
			SAL_DroneClientComponent.GetInstance().UpdatePowers(pOwnerEntity, false);
	}
